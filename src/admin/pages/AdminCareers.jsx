...
//     <div className='md:grid grid-col-5 gap-2'>
//       <div className='col-span-1'>
//         <AdminSideBar/>
//       </div>
//       <div className='col-span-4 p-10'>
//         <h1 className='text-center text-3xl font-bold'>All Careers</h1>

//         {/* tabs */}

//         <div className='flex justify-center items-center my-8 font-medium text-lg'>
//           <p onClick={()=>{setJobPostStatus(true),setApplicationListStatus (false)}} className={jobPostStatus ? "text-blue-500 p-4 border-gray-200 border-l border-t  border-r rounded cursor-pointer" : 'border-b p-4 border-gray-200 cursor-pointer'}>Job Post</p>
//           <p onClick={()=>{setJobPostStatus(false),setApplicationListStatus (true)}} className={applicationListStatus ? "text-blue-500 p-4 border-gray-200 border-l border-t  border-r rounded cursor-pointer" : 'border-b p-4 border-gray-200 cursor-pointer'}>View Applicant</p>
//         </div>
...
//             <img width={"100px"} height={"300px"} src=" " alt="" />
...
//             <p className='text-red-700 font-bold'>ID: 9867862956</p>
