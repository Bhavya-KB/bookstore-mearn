...
function LandingPage() {
  ...
  return (
    ...
    <section className='md:px-40  p-5 flex flex-col justify-center items-center'>
        <h1 className='text-red-800 font-bold text-4xl'>New Arrivals</h1>
       ...
       <div className='md:grid grid-cols-4 w-full mt-5'>
              ...
              <div className='p-3'>
                <div className='shadow p-3 rounded'>
                    ...
                    <div className='text-center mt-3'>
                        ...
                        <p className='font-bold text-l'>{item.author}</p>
        ...
        <div>
<Link to={"/all-books"}><button className='px-3 py-2 bg-blue-900 text-white hover:border 
hover:border-blue-900 hover:text-blue-900 hover:bg-white'>Explore More</button></Link>
        </div>
