...
//         <h1 className='text-3xl font-bold mb-5 text-red-800'>Careers</h1>
//         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint quaerat quibusdam animi fugiat labore repudiandae non. Aliquam, et minus soluta molestiae placeat rerum consequatur facere omnis deserunt cumque amet eaque.</p>
...
//         <div className='flex mb-5'>
//           <div className='w-full'>
//             <h1 className='text-xl font-bold pb-3'>Frontend Developer</h1>
//             <hr />
...
//         <p className='flex'><FaLocationDot  className='me-2 mt-1'/>Kochi</p>
//         <p className='text-lg my-2'>Job Type :Full time</p>
//          <p className='text-lg my-2'>Salary : 20000- 30000</p>
//           <p className='text-lg my-2'>Qualification: BSC.CS</p>
//            <p className='text-lg my-2'>Experince: 1-2 yrs</p>
//             <p className='text-lg my-2 text-justify'>Description : Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit iusto optio veniam asperiores expedita placeat culpa distinctio, vel iste, consequatur similique atque hic alias fuga voluptatum saepe nobis ea odit.</p>
