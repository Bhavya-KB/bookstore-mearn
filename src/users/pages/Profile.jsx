...
function Profile() {
  ...
  return (
    ...
    <div style={{ height: "200px" }} className="bg-black"></div>
        ...
        <p className="md:px-20 px-5 my-5 text-xl">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis sunt
          amet dolorum rerum corporis? Natus, beatae, earum cum inventore sapiente
          reprehenderit dolore dolorem esse impedit quam libero non asperiores
          fugiat?
        </p>
        ...
        <div className="flex justify-center items-center my-8 font-medium text-lg">
          <p
            onClick={() => {
              setSellbooks(true), setBookStatus(false), setPurchaseHistory(false);
            }}
            className={
              sellBooks
          ...
          <p
            onClick={() => {
              setSellbooks(false), setBookStatus(true), setPurchaseHistory(false),getUserBooks;
            }}
            className={
              bookstatus
                ? "text-blue-500 p-4 border-gray-200 border-t border-l border-r rounded cursor-pointer"
          ...
          <p
            onClick={() => {
              setSellbooks(false), setBookStatus(false), setPurchaseHistory(true),  fetchPurchasedBooks();
            }}
            className={
              purchaseHistory
                ? "text-blue-500 p-4 border-gray-200 border-t border-l border-r rounded cursor-pointer"
              ...
              <form className="md:grid grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    id=""
                    placeholder="Author"
                    className="bg-white rounded w-full p-2 mt-3"
                  />
                  <input
                ...
                <div>
                  ...
                  <div className="flex md:justify-end justify-center mt-5">
                    <button
                      onClick={reset}
                      className="bg-red-600 text-white rounded px-5 py-3  hover:border hover:border-red-green-600 hover:text-red-600 hover:bg-white"
                    >
                      Reset
                    </button>
                    <button
                      ...
                      className="bg-green-600 text-white rounded px-5 py-3  hover:border hover:border-green-600 hover:text-green-600 hover:bg-white ms-3"
                    >
                      Submit
                    </button>
                  </div>
              ...
              <div className="md:grid grid-cols-[3fr_1fr]">
                ...
                <div className="px-4 mt-4 md:mt-4">
                  ...
                  <div className="flex justify-end mt-4">
                    <button onClick={()=>handleDeleteBoook(book?._id)}
                      type="button"
              ...
              <div className="md:grid grid-cols-[3fr_1fr]">
                <div className="px-4">
                  ...
                  <p>
                    ...
                    Consequuntur itaque rerum ratione molestiae soluta dolore
                    atque quas, quam ipsa illum, ipsam earum accusamus.
                    Exercitationem, eos? Lorem ipsum dolor sit amet consectetur
                    adipisicing elit. Doloremque perferendis minima a sapiente,
                    animi magnam natus asperiores, voluptates veritatis, deleniti
                    facilis sequi? Animi molestias, mollitia saepe nisi odit totam
                    impedit.
                  </p>
                </div>
                <div className="px-4 mt-4 md:mt-4">
                  <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjQKSzrlRv0wb3db0f2RSxKrVYJuFI_6Uk4w&s"
                    alt=""
                    style={{ width: "200px", height: "200px" }}
                  />
                </div>
    ...
    {purchasedBooks.length === 0 ? (
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        {purchasedBooks.map((book) => (
          <div key={book._id} className='p-4 shadow-lg rounded bg-white'>
